...
public class Model {
    ...
    private ArrayList<Sehenswürdigkeit> sehenswürdigkeitList = new ArrayList<Sehenswürdigkeit>(Arrays.asList( new Sehenswürdigkeit("Goldschmiede", "Die Goldschmiede wurde 1990 gebaut", R.drawable.goldschmiede),
